...
build_evaluate_model <- function(splits, lc_code) {
  # access the splits
...
get_unbalanced_single_row <- function(df, lc_code, seed = 226, lc_dataset) {
  # print(lc_code)
...
get_a_single_row <- function(df, lc_code, seed = 226, lc_dataset) {
  # print(lc_code)
